...
pkgdatadir = $(datadir)/voodootracker
pkglibdir = $(libdir)/voodootracker
pkgincludedir = $(includedir)/voodootracker
...
GNOME_APPLET_LIBS = -rdynamic -lpanel_applet -lgnorba -lORBitCosNaming -lORBit -lIIOP -lORBitutil -lnsl -lgnomeui -lart_lgpl -lgdk_imlib -lSM -lICE -lgtk -lgdk -lgmodule -lXi -lXext -lX11 -lgnome -lgnomesupport -lesd -laudiofile -lm -ldb1 -lglib -ldl
...
CONFIG_CLEAN_FILES =  voodoo.spec
DIST_COMMON =  README ./stamp-h.in AUTHORS COPYING ChangeLog INSTALL \
Makefile.am Makefile.in NEWS TODO acconfig.h aclocal.m4 config.h.in \
configure configure.in install-sh missing mkinstalldirs voodoo.spec.in
...
voodoo.spec: $(top_builddir)/config.status voodoo.spec.in
